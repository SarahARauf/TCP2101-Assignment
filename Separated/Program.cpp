...
void Program::parseCommands()
{
    for (auto c : commands) // for each of the user's commands
    {
        ...
        else if (commandType.compare("push") == 0 || commandType.compare("pop") == 0 || commandType.compare("top") == 0 || commandType.compare("isEmpty") == 0 || commandType.compare("isFull") == 0 || commandType.compare("clone") == 0 || commandType.compare("delete") == 0 || commandType.compare("search") == 0 || commandType.compare("sort") == 0)
        {
